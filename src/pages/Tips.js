  ...
  return (
    <div className="tips-page">
      ...
      <div className="p">
        ...
        <div className="p-9">
          <span className="span"> Cheeses </span> - can be incorporated into
          almost any concept and any meal. The obvious is cheese-based
          hospitality - to which only breads or crackers, fruit and nuts are
          added - but cheeses can do much more than that. Here are some
          examples:
        </div>
        <div className="p-10">
          <ul>
            <li>
              ...
              , each of which has a different topping with a different cheese,
              for example a broccoli pesto broccoli and a king of the forest
              steak with parmesan, ratatouille bruschetta and smoked gouda;
              Bruschetta with gouda tom goats and artichokes etc.
            </li>
            <li>
              Cheeses can also be at the center of light hospitality dishes,
              ones that have 3-4 quality ingredients, for example stewed
              asparagus topped with smoked Gouda carvings; Roasted beets with
              blue cheese and nuts; Halved figs with goat cheese and a drizzle
              of honey, a loaf of bread that make grooves in it and fill them
              with various hard cheeses and crushed garlic cloves or spreads
              like pesto and sun-dried tomatoes or hard cheese cubes seasoned
              with olive oil and hot pepper or sun-dried tomatoes and served as
              a snack.
            </li>
            <li>
              {" "}
              The addition of cheese can also give an invested touch to everyday
              dishes - for example fried diced cubes on a green salad (the lazy
              can make it from a purchased washed leaf mixture) or diced
              Bulgarian cheese on a simple green salad. On the same principle,
              you can spread sheep or goat yogurt on a nice serving plate,
              season with a little hyssop, blush or paprika that will add color
              and thus serve a lentil or cereal salad.
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="pp">
        <div className="p-11">
          ...
          tomato spread, egg salad, eggplant salad and more. You can place them
          on a buffet table for spreading, or use them as an ingredient in
        ...
        <div className="p-12">
          <b>Quality preserves</b> The base is olives and pickles of various
          kinds, but you can expand the canvas with gherkins, capers (small and
          large) and artichokes a la Romana and even find in deli delicacies
          also less routine preserves, for example patissons, pickled peppers
          stuffed with cheese or garlic confit. And of course, if the menu is
          appropriate - to this category you can also add pickled and smoked
          fish.
        </div>
        <div className="p-13">
          <b>Spices and spice mixes</b> Beautiful saucers with coarse salt,
          ground black pepper and a spice mixture that is suitable for cheeses
          or vegetables will also add to the variety on the table and will also
          add interest to the dishes.
        </div>
        <div className="p-14">
